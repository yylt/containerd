...
const (
	XFS_USER_QUOTA  quotaType = (1 << iota)
	XFS_PROJ_QUOTA  quotaType = (1 << iota)
	XFS_GROUP_QUOTA quotaType = (1 << iota)
)
...
const (
	Q_XQUOTAON  quotaCmd = iota + 1 /* enable accounting/enforcement */
	Q_XQUOTAOFF                     /* disable accounting/enforcement */
	Q_XGETQUOTA                     /* get disk limits and usage */
	Q_XSETQLIM                      /* set disk limits */
	Q_XGETQSTAT                     /* get quota subsystem status */
	Q_XQUOTARM                      /* free disk space used by dquots */
)
